document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.type === 'tel' && input.value.trim() && !/^[\d\s\-\+\(\)]{7,}$/.test(input.value.trim())) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.classList.contains('touched') || input.dataset.touched) {
                validateField(input);
            }
        });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e2ad2b13-a779-4766-9445-994d664a8f07',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e2ad2b13-a779-4766-9445-994d664a8f07';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e2ad2b13-a779-4766-9445-994d664a8f07';
